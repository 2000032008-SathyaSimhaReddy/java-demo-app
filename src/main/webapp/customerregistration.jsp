...
<tr>
<td><label>Type Of Appointments</label></td>
<td>
<form:select path="typeofvisa" required="required">
<form:option value="-1">---Select---</form:option>
<form:option value="Business Visa">senior Doctor</form:option>
<form:option value="Tourist Visa">Junior Doctor</form:option>
<form:option value="Student Visa">X-rays and Scaning</form:option>
</form:select>
</td>
</tr>
